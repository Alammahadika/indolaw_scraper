...
def get_detail_data(url):
    """Ekstrak semua data detail dari halaman peraturan Kemendikdasmen"""
    soup = get_soup(url)
    
    # Ambil judul utama
    title = soup.find("h3").get_text(strip=True) if soup.find("h3") else "N/A"
...
if __name__ == "__main__":
    url = "https://jdih.kemendikdasmen.go.id/detail_peraturan?main=3567"
