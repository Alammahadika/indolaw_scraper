...
def scrape_pu_detail(url: str):
    ...
    # Kalau halaman detail
    doc = scraper.scrape_document(url)
    if not doc:
        return None
    return asdict(doc)
...
if __name__ == "__main__":
    ...
    doc_url = "https://jdih.pu.go.id/detail-dokumen/KepSekJen-nomor-514KPTSSJ2025-tahun-2025-Penetapan-Tim-Pengelola-Layanan-Pengaduan-Kementerian-Pekerjaan-Umum-melalui-Sistem-Pengelolaan-Pengaduan-Pelayanan-Publik-Nasional--Layanan-Aspirasi-dan-Pengaduan-Online-Rakyat"
